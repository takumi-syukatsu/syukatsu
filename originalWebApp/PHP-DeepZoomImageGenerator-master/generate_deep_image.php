<?php
	...
	// Example
	$image = imagecreatefromjpeg('combinedImage.jpg');	// Image to use to generate the tree
	$tree_name = 'deepZoomImages';									// Name of tree and viewer
	$zoom = 4;												// Zoom establish total number of cells and image size
															//	if zoom = 2 then
	...
	$cell_x = 448;											// Cell X (Cell X does not need to be = Cell Y, is just an example)
	$cell_y = 240;											// Cell Y
